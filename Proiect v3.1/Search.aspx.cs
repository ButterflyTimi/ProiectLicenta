        ...
        if (q != null)
        {
            ...
            if (a == null || a =="data")
                try
                {
                    ...
                    SqlDataSource1.SelectCommand = " SELECT Carti.Id AS CartiId, Carti.Titlu AS CartiTitlu, Carti.Poza_Coperta, Genuri.Gen, Autori.Prenume + ' ' + Autori.Nume AS NumeAutor FROM Autori INNER JOIN Genuri INNER JOIN Carti ON Genuri.Id = Carti.Id_Gen ON Autori.Id = Carti.Id_Autor WHERE Carti.Titlu like @q OR Genuri.Gen like @q OR Autori.Nume like @q OR Autori.Prenume like @q OR Autori.Prenume + ' ' + Autori.Nume like @q OR Autori.Nume + ' ' + Autori.Prenume like @q ORDER BY CartiId ";
